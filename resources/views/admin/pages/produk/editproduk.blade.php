                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Tambah Produk <span>| Simple Fashion</span></h5>  
                                <form class="row g-3"action="{{ url('/admin/produk/'.$produk->slug) }}" method="post" enctype="multipart/form-data">
                                    @method( 'PUT')
                                    @csrf
                                    <div class="col-12">
                                        <label  for="name" class="form-label">Nama Produk</label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name',$produk->name) }}" required >
                                        @error('name')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            @if (old('category_id',$produk->category_id) == $ctg->id)
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            @if ($produk->image)
                                            <img src="{{asset('storage/'. $produk->image) }}" class="img-preview img-fluid mb-3 d-block" width="150 ">
                                            @else
                                            <img class="img-preview img-fluid mb-3" width="150 ">
                                            @endif 
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-4">
                                            <img class="img-preview2 img-fluid " width="150 ">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <input id="description" class="@error('description') is-invalid @enderror" type="hidden" name="description" value="{{ old('description',$produk->description) }}">
...
<script>
    ...
    function previewImagetransparent(){
        const image2 = document.querySelector('#imagetransparent');
